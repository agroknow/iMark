...
listing.controller("mainController", function($rootScope, $scope, $http, $routeParams, $location, $modal, $log, sharedProperties){
	...
	$scope.carousel_images = [
		{image:'assets/carousel/aromaticherb.png', url:'http://education.natural-europe.eu/natural_europe/exhibits/show/aromatic-herbs/to-begin-with'},
		{image:'assets/carousel/deinotherium.png', url:'http://education.natural-europe.eu/natural_europe/exhibits/show/DeinotheriumCrete/to-begin-with?nhm=NHMC'},
		{image:'assets/carousel/mediterranean.png', url:'http://education.natural-europe.eu/natural_europe/exhibits/show/Pathway-slug-328/to-begin-with?nhm=NHMC'}];
